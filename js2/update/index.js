...
const bounce = e => (e.y - canvas.height + e.h > 0 && e.v_y > 0) ? {...e, v_y: -(e.v_y - 1 > 0 ? e.v_y -1 : 0)} : e
...
const __update = {
  ...
  backImg: data => data.x < -canvas.width ? ({...data, x: 0}) : _.flowRight(addInterval(1)(updateSelf()))(data),
